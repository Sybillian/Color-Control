...
scoreboard players set LengthDivide gameSettings 2
scoreboard players operation HalfLength gameSettings = GameLength gameSettings
scoreboard players operation HalfLength gameSettings /= LengthDivide gameSettings
...
execute @e[score_cloudType=9,score_cloudType_min=9] ~ ~ ~ summon armor_stand ~ 60 ~ {NoGravity:1b,Marker:1b,Invisible:1,Invulnerable:1,NoBasePlate:1,ArmorItems:[{},{},{},{id:splash_potion,Count:1b,tag:{Potion:"minecraft:swiftness"}}],Tags:["display"]}

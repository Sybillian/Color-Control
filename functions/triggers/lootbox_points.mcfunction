...
execute @e[type=area_effect_cloud,tag=storage,name=Red,score_calcPoints=0,score_calcPoints_min=-10] ~ ~ ~ setblock 969 51 969 minecraft:chest facing=south destroy {LootTable:"cc:chests/tier_1"}
...
execute @e[type=area_effect_cloud,tag=storage,name=Blue,score_calcPoints=0,score_calcPoints_min=-10] ~ ~ ~ setblock 1031 51 1031 minecraft:chest facing=north destroy {LootTable:"cc:chests/tier_1"}
